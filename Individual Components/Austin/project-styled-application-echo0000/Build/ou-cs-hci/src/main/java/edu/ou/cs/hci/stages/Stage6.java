...
public final class Stage6
{
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		Color mainColor = Color.decode("#6090D9");
		Color textBackground = Color.decode("#F3F6F6");
		Color darkColor = Color.decode("#253A5E");
		
		JFrame	frame = new JFrame("Proud Puppies");
		frame.getContentPane().setBackground(mainColor);
		JPanel	logInUpload = new JPanel();
		logInUpload.setBackground(mainColor);
		JPanel	filterSearch = new JPanel();
		filterSearch.setBackground(mainColor);
		
		JPanel	bigPicture = new HelloPanel("Display");
		bigPicture.setBackground(textBackground);
		...
		itemList.setBackground(textBackground);
		itemList.setForeground(darkColor);
		...
		logInOutBtn.setBackground(darkColor);
		uploadBtn.setBackground(darkColor);
		filterBtn.setBackground(darkColor);
		searchBtn.setBackground(darkColor);
		
		logInOutBtn.setForeground(textBackground);
		uploadBtn.setForeground(textBackground);
		filterBtn.setForeground(textBackground);
		searchBtn.setForeground(textBackground);
		...
		JButton pic1 = new JButton("Pic1");
		pic1.setBackground(darkColor);
		pic1.setForeground(textBackground);
		
		JButton pic2 = new JButton("Pic2");
		pic2.setBackground(darkColor);
		pic2.setForeground(textBackground);
		
		JButton pic3 = new JButton("Pic3");
		pic3.setBackground(darkColor);
		pic3.setForeground(textBackground);
		
		JButton pic4 = new JButton("Pic4");
		pic4.setBackground(darkColor);
		pic4.setForeground(textBackground);
		...
		frame.getContentPane().add(pic1, c);
		...
		c.gridwidth = 1;
	    c.insets = new Insets(20,0,0,20);
		frame.getContentPane().add(pic2, c);
		...
		c.gridwidth = 1;
	    c.insets = new Insets(20,0,0,20);
		frame.getContentPane().add(pic3, c);
		...
		c.gridwidth = 1;
	    c.insets = new Insets(20,0,0,20);
		frame.getContentPane().add(pic4, c);
	...
	public static void createMenuBar(JFrame frame)
	{
		...
		menuBar.setBackground(Color.decode("#253A5E"));
		menuBar.setForeground(Color.decode("#F3F6F6"));
		menuBar.setPreferredSize(new Dimension(987, 40));
		
		JMenu 	  fileMenu = new JMenu("File");
		fileMenu.setForeground(Color.decode("#F3F6F6"));
		
		JMenu 	  editMenu = new JMenu("Edit");
		editMenu.setForeground(Color.decode("#F3F6F6"));
		
		JMenu 	  helpMenu = new JMenu("Help");
		helpMenu.setForeground(Color.decode("#F3F6F6"));
		
		JMenu 	  accountMenu = new JMenu("Account");
		accountMenu.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem fileUpload = new JMenuItem("Upload");
		fileUpload.setBackground(Color.decode("#253A5E"));
		fileUpload.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem fileDelete = new JMenuItem("Delete");
		fileDelete.setBackground(Color.decode("#253A5E"));
		fileDelete.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem fileOpen = new JMenuItem("Open");
		fileOpen.setBackground(Color.decode("#253A5E"));
		fileOpen.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem fileSave = new JMenuItem("Save");
		fileSave.setBackground(Color.decode("#253A5E"));
		fileSave.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem filePrint = new JMenuItem("Print");
		filePrint.setBackground(Color.decode("#253A5E"));
		filePrint.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem fileShare = new JMenuItem("Share");
		fileShare.setBackground(Color.decode("#253A5E"));
		fileShare.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem fileQuit = new JMenuItem("Quit");
		fileQuit.setBackground(Color.decode("#253A5E"));
		fileQuit.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem editZoom = new JMenuItem("Zoom");
		editZoom.setBackground(Color.decode("#253A5E"));
		editZoom.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem editCut = new JMenuItem("Cut");
		editCut.setBackground(Color.decode("#253A5E"));
		editCut.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem editCopy = new JMenuItem("Copy");
		editCopy.setBackground(Color.decode("#253A5E"));
		editCopy.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem editPaste = new JMenuItem("Paste");
		editPaste.setBackground(Color.decode("#253A5E"));
		editPaste.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem 	  adorablesSubMenu = new JMenu("Adorables");
		adorablesSubMenu.setBackground(Color.decode("#253A5E"));
		adorablesSubMenu.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem adorablesView = new JMenuItem("View");
		adorablesView.setBackground(Color.decode("#253A5E"));
		adorablesView.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem adorablesAdd = new JMenuItem("Add");
		adorablesAdd.setBackground(Color.decode("#253A5E"));
		adorablesAdd.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem adorablesReorder = new JMenuItem("Reorder");
		adorablesReorder.setBackground(Color.decode("#253A5E"));
		adorablesReorder.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem adorablesRemove = new JMenuItem("Remove");
		adorablesRemove.setBackground(Color.decode("#253A5E"));
		adorablesRemove.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem helpReport = new JMenuItem("Report");
		helpReport.setBackground(Color.decode("#253A5E"));
		helpReport.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem helpPartners = new JMenuItem("Proud Partners");
		helpPartners.setBackground(Color.decode("#253A5E"));
		helpPartners.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem helpContact = new JMenuItem("Contact Us");
		helpContact.setBackground(Color.decode("#253A5E"));
		helpContact.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem accountLogging = new JMenuItem("Log In/Out");
		accountLogging.setBackground(Color.decode("#253A5E"));
		accountLogging.setForeground(Color.decode("#F3F6F6"));
		
		JMenuItem accountSettings = new JMenuItem("Settings");
		accountSettings.setBackground(Color.decode("#253A5E"));
		accountSettings.setForeground(Color.decode("#F3F6F6"));
	...
	public static void createToolBar(JMenuBar menuBar)
	{
		...
		tb.setBackground(Color.decode("#253A5E"));
		tb.setForeground(Color.decode("#253A5E"));
		tb.setBorder(BorderFactory.createEmptyBorder());
		
		JButton upload = new JButton();
		upload.setBackground(Color.decode("#253A5E"));
		upload.setForeground(Color.decode("#F3F6F6"));
		JButton delete = new JButton();
		delete.setBackground(Color.decode("#253A5E"));
		delete.setForeground(Color.decode("#F3F6F6"));
		JButton addToAdorables = new JButton();
		addToAdorables.setBackground(Color.decode("#253A5E"));
		addToAdorables.setForeground(Color.decode("#F3F6F6"));
		JButton filter = new JButton();
		filter.setBackground(Color.decode("#253A5E"));
		filter.setForeground(Color.decode("#F3F6F6"));
		JButton search = new JButton();
		search.setBackground(Color.decode("#253A5E"));
		search.setForeground(Color.decode("#F3F6F6"));
	...
	{
	    Color backgrndColor = Color.decode("#253A5E");
